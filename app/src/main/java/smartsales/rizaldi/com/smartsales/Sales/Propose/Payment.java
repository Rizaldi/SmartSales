...
//                        Toast.makeText(Payment.this, organizationId+"-"+warehouseId+"-"+ParamInput.idcustomer, Toast.LENGTH_SHORT).show();
...
//                        params.put("idSO", idSo);
    ...
    private void saveSalesOrder() {
        ...
        loading.show();
        Toast.makeText(getApplicationContext(),idSo,Toast.LENGTH_LONG).show();
        final StringRequest strReq = new StringRequest(Request.Method.POST, UrlLib.url_saveProposeSalesOrder, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(getApplicationContext(),
                        volleyError.getMessage()+"a", Toast.LENGTH_LONG).show();
                loading.dismiss();
            }
        }
        ) {
