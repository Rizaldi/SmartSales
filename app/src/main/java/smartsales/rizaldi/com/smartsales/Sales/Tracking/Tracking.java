...
public class Tracking extends AppCompatActivity{
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TwoFragment(), "Your location");
        adapter.addFragment(new ThreeFragment(), "Camera");
        adapter.addFragment(new FourFragment(), "Transaction");
