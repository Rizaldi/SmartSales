...
public class Goodreturnapprove extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goodreturnapprove);
    ...
    private void getDataGood(String key, String value) {
        final ProgressDialog loading = new ProgressDialog(this);
        loading.setMessage("please wait...");
        loading.setCancelable(false);
        loading.show();
        StringRequest strReq = new StringRequest(Request.Method.GET, UrlLib.url_listapprovegood+positionstatus+"&"+
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if(code.equals("1")){
                        ...
                        Toast.makeText(Goodreturnapprove.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                list.clear();
                adapter = new RVAadapter(list, Goodreturnapprove.this);
    ...
    private void parseDataList(JSONArray jsonArray) {
        ...
        for (i = 0; i<jsonArray.length(); i++){
            ...
            try {
                ...
                Items.setCustomer_location_id(jsonObject.getString("customer_location_id"));
                Items.setCustomer_location(jsonObject.getString("customer_location"));
                Items.setCustomer_location(jsonObject.getString("customer_location"));
                Items.setStatus(jsonObject.getString("status"));
                Items.setCreated_on(jsonObject.getString("created_on"));
                Items.setItems(jsonObject.getString("items"));
                Items.setTotal_return(jsonObject.getString("total_return"));
                String status="";
                if(jsonObject.getString("approval_status").equals("0")){
                    status="Waiting For Approval By ASM";
                }else if(jsonObject.getString("approval_status").equals("1")){
                    status="Waiting For Approval By NSM";
                }else if(jsonObject.getString("approval_status").equals("2")){
                    status="Approved";
                }else{
                    status="Rejected";
                }
                Items.setApproval_status(status);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            if (i == 0 && list.size() != 0) {
