...
public class Productlist extends AppCompatActivity {
    RecyclerView rv;
    RVAadapterList adapter;
    private List<ModelProductlist> list;
    @Override
    ...
    private void getDataDetail(String id) {
        ...
        loading.show();
        StringRequest strReq = new StringRequest(Request.Method.GET, UrlLib.url_getdetailgoodreturn +id, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (code.equals("1")) {
                        ...
                        Toast.makeText(Productlist.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                list.clear();
                adapter = new RVAadapterList(list, Productlist.this);
    ...
    private void parseDataList(JSONArray jsonArray) {
        ...
        for (i = 0; i < jsonArray.length(); i++) {
            ...
            try {
                ...
                Items.setQuanity(jsonObject.getString("qty"));
                Items.setUom(jsonObject.getString("uom_name"));
                Items.setCondition(jsonObject.getString("condition"));
                Items.setExpired(jsonObject.getString("expired_date"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
            if (i == 0 && list.size() != 0) {
        ...
        adapter = new RVAadapterList(list, this);
        rv.setAdapter(adapter);
    }
}
