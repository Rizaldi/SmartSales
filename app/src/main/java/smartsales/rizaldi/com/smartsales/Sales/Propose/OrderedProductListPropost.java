...
public class OrderedProductListPropost extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OrderedProductListPropost.this, smartsales.rizaldi.com.smartsales.customerorder.BrowseProduct.class));
                finish();
            }
        });
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (code.equals("1")) {
                        ...
                        String msg = jsonObject.getString("message");
                        Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_LONG).show();
                        Intent i=new Intent(OrderedProductListPropost.this,OrderedProductListPropost.class);
                        Bundle b=new Bundle();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.remove:
                ...
                ParamInput.PoDate = "";
                startActivity(new Intent(OrderedProductListPropost.this, ProposeSalesOrder.class));
                finish();
                break;
            case R.id.add:
                ParamInput.idSO = idSO;
            ...
            case R.id.payment:
                ...
                Intent i = new Intent(OrderedProductListPropost.this, Payment.class);
                i.putExtras(b);
                startActivity(i);
                finish();
                break;
